...
# Bet amount: The amount you as the bet creator are wagering on your side of the bet.
...
TeaLink is build using the Hardhat Framework and below explains commands of how to run hardhat tasks taken from chainlink hardhat repo: 
